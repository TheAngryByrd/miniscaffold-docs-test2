...
[<assembly: AssemblyTitleAttribute("miniscaffold-docs-test2.Tests")>]
[<assembly: AssemblyProductAttribute("miniscaffold-docs-test2")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "miniscaffold-docs-test2.Tests"
    let [<Literal>] AssemblyProduct = "miniscaffold-docs-test2"
